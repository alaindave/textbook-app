...
const MessageDetail = (props) => {
	...
	const { avatar, firstName, lastName, message, authorID, inSentMessage, from } = props.location.state;
	...
	return (
		<div>
			...
			>
				{from ? <span className={classes.from_to}>From: </span> : <span className={classes.from_to}>To: </span>}
